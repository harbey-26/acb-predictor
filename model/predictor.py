...
def predict(
    ...
    return {
        ...
        "confianza":        confianza,
        "features_usadas": {
            "home_win_rate_reciente":  round(s(home_stats, "win_rate"), 3),
            "away_win_rate_reciente":  round(s(away_stats, "win_rate"), 3),
            "home_pts_promedio":       round(s(home_stats, "pts_avg"), 1),
            "away_pts_promedio":       round(s(away_stats, "pts_avg"), 1),
            "home_val_promedio":       round(s(home_stats, "val_avg"), 1),
            "away_val_promedio":       round(s(away_stats, "val_avg"), 1),
